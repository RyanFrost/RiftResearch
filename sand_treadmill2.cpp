...
//********************************
	while( true )
	{
		...
		while(!sdata->beep){cout << sdata->beep << "\n";}
		cout << "Beeping\n";
		// Sand Stiffness
		sdata->Kd = 6e4; 
		...
		while(!end_low_stiff)
		{
			...
			cout << "Foot pos = " << xf << "\n";
			if (xf <= past1 && past1 <= past2 && past2 <= past3)
				end_low_stiff == TRUE;
			else
				end_low_stiff == FALSE;
...
//{
//	fprintf(fp,"%d %f %f %f %f %f %f %f %f %d %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %d %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n", d->motorv_int /*1*/, d->lc1_lbs/*2*/, d->lc2_lbs/*3*/, d->time /*4*/,d->tspeed_desired/*5*/, d->xd/*6*/,d->xact/*7*/,d->foot_pos_x/*8*/, d->mid_stance_x/*9*/, d->perturb/*10*/,d->angle_enc/*11*/,d->Kd/*12*/,d->Kact/*13*/,d->force_b/*14*/,d->elapsed/*15*/,d->x_markers[0]/*16*/, d->x_markers[1]/*17*/, d->x_markers[2]/*18*/, d->x_markers[3]/*19*/, d->x_markers[4]/*20*/, d->y_markers[0]/*21*/, d->y_markers[1]/*22*/, d->y_markers[2]/*23*/, d->y_markers[3]/*24*/, d->y_markers[4]/*25*/, d->z_markers[0]/*26*/, d->z_markers[1]/*27*/, d->z_markers[2]/*28*/, d->z_markers[3]/*29*/, d->z_markers[4]/*30*/, d->x_markers[5]/*31*/, d->x_markers[6]/*32*/, d->x_markers[7]/*33*/, d->x_markers[8]/*34*/, d->x_markers[9]/*35*/, d->y_markers[5]/*36*/, d->y_markers[6]/*37*/, d->y_markers[7]/*38*/, d->y_markers[8]/*39*/, d->y_markers[9]/*
40*/, d->z_markers[5]/*41*/, d->z_markers[6]/*42*/, d->z_markers[7]/*43*/, d->z_markers[8]/*44*/, d->z_markers[9]/*45*/,d->numEMG/*46*/);//, d->sharedData[0]/*47*/,d->sharedData[1]/*48*/,d->sharedData[2]/*49*/,d->sharedData[3]/*50*/,d->sharedData[4]/*51*/,d->sharedData[5]/*52*/,d->sharedData[6]/*53*/,d->sharedData[7]/*54*/,d->sharedData[8]/*55*/,d->sharedData[9]/*56*/,d->sharedData[10]/*57*/,d->sharedData[11]/*58*/,d->sharedData[12]/*59*/,d->sharedData[13]/*60*/);
...
void save2file(sensor_data * d) 
{
	fprintf(fp,"%d %f %f %f %f %f %f %f %f %d %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %d %d %d %d %d %d %d %d %d %d %d %f %f %f %f %f %f %f\n", d->motorv_int /*1*/, d->lc1_lbs/*2*/, d->lc2_lbs/*3*/, d->time /*4*/,d->tspeed_desired/*5*/, d->xd/*6*/,d->xact/*7*/,d->foot_pos_x/*8*/, d->mid_stance_x/*9*/, d->perturb/*10*/,d->angle_enc/*11*/,d->Kd/*12*/,d->Kact/*13*/,d->force_b/*14*/,d->elapsed/*15*/,d->x_markers[0]/*16*/, d->x_markers[1]/*17*/, d->x_markers[2]/*18*/, d->x_markers[3]/*19*/, d->x_markers[4]/*20*/, d->y_markers[0]/*21*/, d->y_markers[1]/*22*/, d->y_markers[2]/*23*/, d->y_markers[3]/*24*/, d->y_markers[4]/*25*/, d->z_markers[0]/*26*/, d->z_markers[1]/*27*/, d->z_markers[2]/*28*/, d->z_markers[3]/*29*/, d->z_markers[4]/*30*/, d->x_markers[5]/*31*/, d->x_markers[6]/*32*/, d->x_markers[7]/*33*/, d->x_markers[8]/*34*/, d->x_markers[9]/*35*/, d->y_markers[5]/*36*/, d->y_markers[6]/*37*/, d->y_markers[7]/*38*/, d->y_markers[8]/*39*/, d->y_
markers[9]/*40*/, d->z_markers[5]/*41*/, d->z_markers[6]/*42*/, d->z_markers[7]/*43*/, d->z_markers[8]/*44*/, d->z_markers[9]/*45*/,d->forcesensors_int[0]/*46*/,d->forcesensors_int[1]/*47*/,d->forcesensors_int[2]/*48*/,d->forcesensors_int[3]/*49*/,d->forcesensors_int[4]/*50*/,d->forcesensors_int[5]/*51*/,d->forcesensors_int[6]/*52*/,d->forcesensors_int[7]/*53*/,d->numEMG/*54*/,d->cycle/*55*/,d->get_EMG/*56*/,d->time_emg/*57*/,d->time_vst_startEMG/*58*/,d->time_vst_absolute/*59*/,d->start_aq_grt/*60*/,d->start_aq_gtod/*61*/,d->time_emg_startEMG/*62*/,d->time_emg_absolute/*63*/); 
